...
export const API_BASE_URL = 'https://code.textmode.art/api/textmode.filters.js';
export const PACKAGE_LABEL = 'textmode.filters.js';
export const CHECK_EXAMPLE_SKETCHES = true;
export const API_DOCS_DIR = path.resolve('api/textmode.filters.js');
