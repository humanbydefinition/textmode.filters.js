var n,e;n=this,e=function(t){const r=()=>({name:"textmode.filters",version:"1.0.0",async install(o){o.filters.register("brightness",`#version 300 es
...
}`,{u_amount:["amount",1]}),o.filters.register("contrast",`#version 300 es
precision highp float;
...
void main() {
    ...
    fragColor = vec4(result, color.a);
}`,{u_amount:["amount",1]}),o.filters.register("hueRotate",`#version 300 es
precision highp float;
...
`,{u_angle:["angle",0]}),o.filters.register("glitch",`#version 300 es
precision highp float;
...
`,{u_amount:["amount",0]}),o.filters.register("chromaticAberration",`#version 300 es
precision highp float;
...
`,{u_amount:["amount",5],u_direction:["direction",[1,0]]}),o.filters.register("pixelate",`#version 300 es
precision highp float;
...
`,{u_pixelSize:["pixelSize",4]})},async uninstall(o){o.filters.unregister("brightness"),o.filters.unregister("contrast"),o.filters.unregister("hueRotate"),o.filters.unregister("glitch"),o.filters.unregister("chromaticAberration"),o.filters.unregister("pixelate")}});typeof window<"u"&&(window.createFiltersPlugin=r),t.createFiltersPlugin=r,Object.defineProperty(t,Symbol.toStringTag,{value:"Module"})},typeof exports=="object"&&typeof module<"u"?e(exports):typeof define=="function"&&define.amd?define(["exports"],e):e((n=typeof globalThis<"u"?globalThis:n||self).textmodeFilters={});
