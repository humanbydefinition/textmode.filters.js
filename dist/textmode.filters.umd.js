var r,n;r=this,n=function(t){const o=()=>({name:"textmode.filters",version:"1.0.0",async install(e){e.filters.register("brightness",`#version 300 es\r
...
}`,{u_amount:["amount",1]}),e.filters.register("contrast",`#version 300 es\r
precision highp float;\r
\r
uniform sampler2D u_texture;\r
uniform vec2 u_resolution;\r
...
void main() {\r
    ...
    \r
    fragColor = vec4(result, color.a);\r
}`,{u_amount:["amount",1]}),e.filters.register("hueRotate",`#version 300 es\r
precision highp float;\r
\r
uniform sampler2D u_texture;\r
uniform vec2 u_resolution;\r
...
`,{u_angle:["angle",0]}),e.filters.register("glitch",`#version 300 es\r
precision highp float;\r
\r
uniform sampler2D u_texture;\r
uniform vec2 u_resolution;\r
...
`,{u_amount:["amount",0]}),e.filters.register("chromaticAberration",`#version 300 es\r
precision highp float;\r
\r
uniform sampler2D u_texture;\r
uniform vec2 u_resolution;\r
...
`,{u_amount:["amount",5],u_direction:["direction",[1,0]]}),e.filters.register("pixelate",`#version 300 es\r
precision highp float;\r
\r
uniform sampler2D u_texture;\r
uniform vec2 u_resolution;\r
...
`,{u_pixelSize:["pixelSize",4]})},async uninstall(e){e.filters.unregister("brightness"),e.filters.unregister("contrast"),e.filters.unregister("hueRotate"),e.filters.unregister("glitch"),e.filters.unregister("chromaticAberration"),e.filters.unregister("pixelate")}});typeof window<"u"&&(window.createFiltersPlugin=o),t.createFiltersPlugin=o,Object.defineProperty(t,Symbol.toStringTag,{value:"Module"})},typeof exports=="object"&&typeof module<"u"?n(exports):typeof define=="function"&&define.amd?define(["exports"],n):n((r=typeof globalThis<"u"?globalThis:r||self).textmodeFilters={});
